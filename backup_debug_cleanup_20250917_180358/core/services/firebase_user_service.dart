...
class FirebaseUserService {
  ...
  // ========================================================================
  // CACHE SINGLETON - NUEVA IMPLEMENTACIÓN OPTIMIZADA
  // ========================================================================
  ...
  /// **MÉTODO PRINCIPAL OPTIMIZADO** - Carga usuarios con cache singleton
  static Future<List<Map<String, dynamic>>> getAllUsers() async {
    try {
      ...
      // ❌ CACHE EXPIRADO O NO EXISTE - CARGAR DESDE FIREBASE
      if (_cacheDebugEnabled) {
      ...
      if (_cachedUsers != null && _cachedUsers!.isNotEmpty) {
        if (_cacheDebugEnabled) {
          print('⚠️ CACHE FALLBACK: Usando cache expirado debido a error');
        }
        return _cachedUsers!;
      }
